...
import { Instagram, ArrowUp, Plus, Bot } from 'lucide-react';
...
export const FloatingActions: React.FC<FloatingActionsProps> = () => {
  ...
  // Wait for intro loader to finish
  useEffect(() => {
    ...
    <AnimatePresence>
      {loaderDone && (
        ...
        >
          ...
          {/* Social icons revealed when (+) is clicked */}
          <AnimatePresence>
            {isOpen && (
              <motion.div
              ...
              >
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-14 h-14 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg"
                >
                  <WhatsAppIcon />
                </motion.a>
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-14 h-14 flex items-center justify-center rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white shadow-lg"
                >
                  <Instagram size={24} />
                </motion.a>
              </motion.div>
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
            className="w-14 h-14 flex items-center justify-center rounded-full bg-accent text-white shadow-lg z-10"
          >
            <motion.div
